...
while quantidade_embarcacoes < 10:
    ...
    # Posiciona 1 navio porta-aviões
    if quantidade_embarcacoes == 0:
        ...
        if posicao_valida(frota, linha, coluna, orientação, tamanho):
            frota = preenche_frota(frota, disponíveis[0], linha, coluna, orientação, tamanho)
            quantidade_embarcacoes += 1
        else:
            print('Esta posição não está válida!')
    
    # Posiciona 2 navios-tanque
        ...
        if posicao_valida(frota, linha, coluna, orientação, tamanho):
            frota = preenche_frota(frota, disponíveis[1], linha, coluna, orientação, tamanho)
            quantidade_embarcacoes += 1
        else:
            print('Esta posição não está válida!')
    
    # Posiciona 3 contratorpedeiros
        ...
        if posicao_valida(frota, linha, coluna, orientação, tamanho):
            frota = preenche_frota(frota, disponíveis[2], linha, coluna, orientação, tamanho)
            quantidade_embarcacoes += 1
        else:
            print('Esta posição não está válida!')

    # Posiciona 4 submarinos
    else:
        ...
        if posicao_valida(frota, linha, coluna, orientação, tamanho):
            frota = preenche_frota(frota, disponíveis[3], linha, coluna, orientação, tamanho)
            quantidade_embarcacoes += 1
        else:
            print('Esta posição não está válida!')
